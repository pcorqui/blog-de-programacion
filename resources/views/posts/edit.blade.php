        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    Editar articulos
                <a href="{{ route('posts.index') }}" class="btn btn-sm btn-primary float-rigth">crear</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="iframe" name="title" class="form-control"> {{old('iframe',$post->iframe) }} </textarea>
